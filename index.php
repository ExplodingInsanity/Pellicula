...
<img class="descImage" src="./media/placeholder1.png">
<?php
...
?>
<a href="./html/actori.php"><img id="btnActori" class="button" src="./media/btnActori.png" width="1000" height="200"></a>
</div>
<div class="descContainer">
<p class='heading'>Sau alege filmul si noi iti spunem restul</p>
<img class="descImage" src="./media/placeholder2.png">
<p class="description">Daca vrei sa afli informatii despre un actor care a jucat intr-un anumit film, suntem aici sa te ajutam. <br> Impreuna cu informatii despre film vei gasi si o lista cu actorii care se gasesc in baza de date Pellicula, cu un link care te va duce la lista de actori.<br>
Sau daca pur si simplu ai nevoie de un film si ai nevoie de o recomandare, apasa butonul de mai jos pentru sugestii.
</p>
<a href="./html/filme.php"><img id="btnFilme" class="button" src="./media/btnFilme.png" width="1000" height="200"></a>
</div>
<?php
